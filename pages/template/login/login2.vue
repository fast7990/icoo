	...
	export default {
		data() {
			return {
				...
				positionTop: 0,
				globalData: {
					appid: 'wx2912562dc7831bdb', //appid需自己提供，此处的appid我随机编写
					secret: '1de684c400183593fe209704d4f0bfa0', //secret需自己提供，此处的secret我随机编写
				},
			}
		},
						...
						if (code) {
							...
							wx.getUserInfo({
								success: function(res) {
									...
									let l = 'https://api.weixin.qq.com/sns/jscode2session?appid=' + d.appid + '&secret=' + d.secret +
